# import struct
# import json  # 안전한 JSON 처리를 위해 상단에 추가
# import requests
# import numpy as np
# import netCDF4 as nc
# from flask import jsonify  # 명시적 JSON 반환을 위해 추가
...
#                 polygon = [[
#                     [
#                         float(self.mapo_crop_lons[y][x]),
#                         float(self.mapo_crop_lats[y][x])
#                     ],
#                     [
#                         float(self.mapo_crop_lons[y][x + 1]),
#                         float(self.mapo_crop_lats[y][x + 1])
#                     ],
#                     [
#                         float(self.mapo_crop_lons[y + 1][x + 1]),
#                         float(self.mapo_crop_lats[y + 1][x + 1])
#                     ],
#                     [
#                         float(self.mapo_crop_lons[y + 1][x]),
#                         float(self.mapo_crop_lats[y + 1][x])
#                     ],
#                     [
#                         float(self.mapo_crop_lons[y][x]),
#                         float(self.mapo_crop_lats[y][x])
...
#         # [핵심 수정] 파이썬 구조체를 완벽하고 깨끗한 데이터셋으로 빌드하여 반환합니다.
#         response_data = {
